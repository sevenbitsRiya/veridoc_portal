...
class BaseLoggingMixin(object):
            ...
            self.log.update(
                {
                    ...
                    'req_header': self._get_req_header(request), 
                    'req_body': request.data,
                    'res_header': self._clean_data(rendered_content),
                    'res_body': self._clean_data(rendered_content),
    ...
    def _get_req_header(self,request):
        apikey = "APIKEY: " +request.META.get("HTTP_APIKEY",None)
        payload ="PAYLOAD: " +request.META.get("HTTP_PAYLOAD",None)
        return apikey+payload
        # return dict(request.META.items())
