...
class BaseAPIRequestLog(models.Model):
    ...
    req_header = models.TextField(null=True, blank=True)
    req_body = models.CharField(max_length=2000,null=True,blank=True)
    res_header = models.CharField(max_length=2000,null=True,blank=True)
    res_body = models.CharField(max_length=2000,null=True,blank=True)
